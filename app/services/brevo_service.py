...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
    <h1 style="color: #333;">Welcome, {safe_name}!</h1>
...
def _build_plan_change_html(customer_name: str, old_plan: str, new_plan: str) -> str:
    safe_name = html_escape(customer_name)
    safe_old_plan = html_escape(old_plan)
    safe_new_plan = html_escape(new_plan)
    return f"""<!DOCTYPE html>
<html>
<head><meta charset="utf-8"></head>
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <p><strong>Previous plan:</strong> {safe_old_plan}<br>
       <strong>New plan:</strong> {safe_new_plan}</p>
